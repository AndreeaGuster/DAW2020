    ...
    public class Initp : DropCreateDatabaseAlways<DbCtx>
    {
        protected override void Seed(DbCtx ctx)
        {
            ...
            ctx.Books.Add(new Book
            {
                ...
                Publisher = new Publisher { Name = "HarperCollins", ContactInfo = new ContactInfo { PhoneNumber = "0712345678" } },
                BookType = cover1,
            ...
            ctx.Books.Add(new Book
            {
                ...
                Author = "Joel Stein",
                Publisher = new Publisher { Name = "Macmillan Publishers", ContactInfo = new ContactInfo { PhoneNumber = "0712345879" } },
                BookType = cover1,
                Genres = new List<Genre> {
            ...
            ctx.Books.Add(new Book
            {
                ...
                Publisher = new Publisher { Name = "Scholastic", ContactInfo = new ContactInfo { PhoneNumber = "0711345676" } },
                BookType = cover2,
                Genres = new List<Genre> {
            ...
            ctx.Books.Add(new Book
            {
                ...
                Publisher = new Publisher { Name = "Schol", ContactInfo = new ContactInfo { PhoneNumber = "0712665673" } },
                BookType = cover2,
                Genres = new List<Genre> {
